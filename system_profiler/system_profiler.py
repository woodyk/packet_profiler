...
# Outputting the analysis as JSON
os_type = platform.system()
if os_type == "Darwin":
    print(json.dumps(system_analysis_mac, indent=4, sort_keys=True))
elif os_type == "Windows":
    print(json.dumps(system_analysis_windows, indent=4, sort_keys=True))
elif os_type == "Linux":
    print(json.dumps(system_analysis_linux, indent=4, sort_keys=True))
